            ...
            <div class="col-lg-12">
                <div class="card panel-primary ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::model($chatroom, ['url' => URL::to('superadmin/chatrooms', $chatroom->id), 'class' => 'form-horizontal', 'method' => 'put']) !!}
                            <!-- CSRF Token -->
                            ...
                            first('welcome_message', 'has-error') }}">
                                ...
                                <div class='box-body pad'>
                                    <textarea class="summernote" name="welcome_message">{{ $chatroom->welcome_message }}</textarea>
                                </div>
                                <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label for="guest" class="col-sm-2 control-label">Allow Guest</label>
                                <div class="col-sm-10">
                                    <select name="guest" class="form-control">
                                        <option value="">Select</option>
                                        <option value="1" @if($chatroom->guest == '1') selected @endif>Allow</option>
                                        <option value="0" @if($chatroom->guest == '0') selected @endif>Not Allowed</option>
                                    </select>
                                </div>
                                <span class="help-block">{{ $errors->first('guest', ':message') }}</span>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="visibility" class="form-control">
                                            ...
                                            <option value="1" @if($chatroom->visibility == '1') selected @endif>Visible</option>
                                            <option value="0" @if($chatroom->visibility == '0') selected @endif>Hide</option>
                                        </select>
                                    </div>
