...
<head>
    ...
    <link href="{{ asset('josh/css/font-awesome.min.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('josh/vendors/iCheck/css/square/blue.css') }}" rel="stylesheet"/>
            ...
            <div id="container_demo">
                ...
                <div id="wrapper">
                    <div id="login" class="animate form">
                        <form action="{{ route('superadmin.login') }}" autocomplete="on" method="post" role="form" id="login_form" class="my-3">
                            <h3 class="black_bg">
                                Online Chat Portal
                                <br>Log In</h3>
                            <!-- CSRF Token -->
                    ...
                    <div id="forgot" class="animate form">
                        <form action="{{ url('admin/forgot-password') }}" autocomplete="on" method="post" role="form" id="reset_pw">
                            <h3 class="black_bg my-3">
                                <img src="{{ asset('josh/img/logo.png') }}" alt="josh logo"><br>Forgot Password</h3>
...
<script src="{{ asset('josh/js/jquery.min.js') }}" type="text/javascript"></script>
<!-- Bootstrap -->
<script src="{{ asset('josh/js/bootstrap.min.js') }}" type="text/javascript"></script>
<script src="{{ asset('josh/vendors/bootstrapvalidator/js/bootstrapValidator.min.js') }}" type="text/javascript"></script>
<!--livicons-->
<script src="{{ asset('josh/js/raphael.min.js') }}"></script>
<script src="{{ asset('josh/js/livicons-1.4.min.js') }}"></script>
