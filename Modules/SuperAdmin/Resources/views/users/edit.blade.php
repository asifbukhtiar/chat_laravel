        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 my-3">
                <div class="card panel-primary">
                    ...
                    <div class="card-body">
                        <!--main content-->
                    {!! Form::model($user, ['url' => URL::to('/superadmin/user/'. $user->id.''), 'method' => 'put', 'class' => 'form-horizontal','id'=>'commentForm', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                    {{ csrf_field() }}
                    <!-- CSRF Token -->
                        ...
                        <div id="rootwizard">
                            ...
                            <div class="tab-content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="username" name="username" placeholder="Username" type="text"
                                                       class="form-control required username"   value="{!! old('username', $user->username) !!}"/>
                                ...
                                <div class="tab-pane" id="tab2" disabled="disabled">
                                    <p class="text-danger"><strong>Be careful with group selection, if you give superadmin access.. they can access admin section</strong></p>
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control required"  title="Select group..." name="groups[]"
                                                    ...
                                                    @foreach($roles as $role)
                                                        <option value="{!! $role->id !!}" {{ (array_key_exists($role->id, $role) ? ' selected="selected"' : '') }} @if($user->id==1) disabled @endif @if($user->id!=1 && $role->id==1) disabled @endif>{{ $role->name }}</option>
                                                    @endforeach
                                                </select>
