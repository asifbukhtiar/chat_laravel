            ...
            <div class="col-lg-12">
                <div class="card panel-primary ">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        {!! Form::model($autochat, ['url' => URL::to('superadmin/autochat', $autochat->id), 'method' => 'put', 'class' => 'form-horizontal']) !!}
                            <!-- CSRF Token -->
                                    ...
                                    <div class="col-sm-10">
                                        <select name="chatroom_id" class="form-control" required>
                                            ...
                                            @foreach($chatroom as $data)
                                                <option value="{{ $data->id }}" @if($data->id == $autochat->chatroom_id) selected @endif>{{ $data->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                            ...
                            first('code', 'has-error') }}">
                                ...
                                <div class='box-body pad'>
                                    <textarea class="summernote" name="code" required>{{ $autochat->html_code }}</textarea>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="occurence" name="occurence" placeholder="Specify Time of Occurence" type="text" class="form-control"
                                               value="{{ $autochat->occurence }}" required/>
                                    </div>
