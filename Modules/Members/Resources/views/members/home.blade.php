...
<div id="owl-demo" class="owl-carousel owl-theme">
    <div class="item"><img src="{{ asset('frontend/images/slide_1.jpg') }}" alt="slider-image">
    </div>
    <div class="item"><img src="{{ asset('frontend/images/slide_2.jpg') }}" alt="slider-image">
    </div>
    <div class="item"><img src="{{ asset('frontend/images/slide_3.jpg') }}" alt="slider-image">
    </div>
</div>
<!-- //Carousel End -->
<!-- Container Start -->
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="layout-image">
                    <img src="{{ asset('frontend/images/layout.png') }}" class="img-responsive" />
                </div>
            </div>
