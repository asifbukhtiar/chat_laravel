            ...
            <div class="row">
                <div class="col-lg-10 col-12">
                    ...
                    <div class="position-center">
                        ...
                        {!! Form::model($user, ['url' => URL::to('members/my_account'), 'method' => 'put', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data','files'=> true]) !!}
                        ...
                        <i class="livicon" data-name="user" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                        ...
                                        <input type="text" placeholder=" " name="last_name" id="u-lname"
                                               class="form-control"
                        ...
                        <div class="form-group {{ $errors->first('username', 'has-error') }}">
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-12">
                                    <div class="input-group input-group-append">
                                                                <span class="input-group-text">
                        <i class="livicon" data-name="username" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                                </span>
                                        <input type="text" placeholder=" " id="username" name="username" class="form-control"
                        ...
                        <i class="livicon" data-name="calendar" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                ...
                                <div>
                                    <h3 class="text-primary" id="title">Advanced Profile Information</h3>
                                </div>

                                <div class="form-group {{ $errors->first('hobbies', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Hobbies:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="hobbies" class="form-control"
                                                       name="hobbies" value="{!! old('hobbies',$user->hobbies) !!}"/>
                                            </div>
                                            <span class="help-block">{{ $errors->first('hobbies', ':message') }}</span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group  {{ $errors->first('interests', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label for="" class="control-label">interests <small>(brief intro):</small></label>
                                        </div>

                                        <div class="col-lg-10 col-12">
                                            <textarea name="interests" id="interests" class="form-control resize_vertical"
                                                      rows="4">{!! old('interests', $user->interests) !!}</textarea>
                                        </div>
                                ...
                                <div class="form-group {{ $errors->first('language', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Languages:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="language" class="form-control"
                                                       name="language" value="" data-role="tagsinput"/>
                                            </div>
                                ...
                                <div class="form-group {{ $errors->first('religion', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="religion" class="form-control"
                                                       name="religion" value="{!! old('religion',$user->hobbies) !!}"/>
                                            </div>
                                            <span class="help-block">{{ $errors->first('religion', ':message') }}</span>
                                        </div>
                                    </div>

                                </div>

                                <div class="form-group {{ $errors->first('quotes', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="quotes">Favourite Quotations:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="quotes" class="form-control"
                                                       name="quotations" value="" data-role="tagsinput"/>
                                            </div>
                                            <span class="help-block">{{ $errors->first('quotes', ':message') }}</span>
                                        </div>
                                    </div>

                                </div>

                                <div class="form-group {{ $errors->first('movies', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Favourite Movies:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="movies" class="form-control"
                                                       name="movies" value="" data-role="tagsinput"/>
                                            </div>
                                            <span class="help-block">{{ $errors->first('movies', ':message') }}</span>
                                        </div>
                                    </div>

                                </div>

                                <div class="form-group {{ $errors->first('music', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Favourite Music:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="music" class="form-control"
                                                       name="music" value="" data-role="tagsinput"/>
                                            </div>
                                ...
                                <div class="form-group {{ $errors->first('books', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Favourite Books:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="books" class="form-control"
                                                       name="books" value="" data-role="tagsinput"/>
                                            </div>
                                            <span class="help-block">{{ $errors->first('books', ':message') }}</span>
                                        </div>
                                    </div>

                                </div>

                                <div class="form-group {{ $errors->first('shows', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Favourite TV Shows:</label>
                                        </div>
                        ...
                        <i class="livicon" data-name="plus-alt" data-size="16" data-loop="true" data-c="#418bca" data-hc="#418bca"></i>
                                                ...
                                                <input type="text" placeholder=" " id="shows" class="form-control"
                                                       name="shows" value="" data-role="tagsinput"/>
                                            </div>
                                            <span class="help-block">{{ $errors->first('shows', ':message') }}</span>
                                        </div>
                                    </div>

                                </div>

                                <h3 class="text-primary" id="title">User's Privacy & Policy</h3>
                                <div class="form-group {{ $errors->first('privacy', 'has-error') }}">
                                    <div class="row">
                                        <div class="col-lg-2 col-12">
                                            <label class=" control-label" for="postal">Privacy Settings:</label>
                                        </div>

                                        <div class="col-lg-8 col-12">
                                            <div class="input-group input-group-append">
                                                <select name="privacy" class="form-control">
                                                    <option>Select Privacy Policy</option>
