...
<div class="container">
    ...
    <div class="row">
        <div class="box animation flipInX font_size">
            ...
            <form action="{{ route('members.register') }}" method="POST" id="reg_form">
                <!-- CSRF Token -->
                ...
                Already have an account? Please <a href="{{ route('members.login') }}"> Log In </a>
                </a>
            </form>
            <h4 style="text-align: center; margin-top: 8px;">Privacy Policy</h4>
            <div class="row">

                <p class="text-left" style="padding-left: 10px;padding-right: 10px;">
                    @foreach($policy as $pols)
                        {{ $pols->description }}
                    @endforeach
                </p>
            </div>
