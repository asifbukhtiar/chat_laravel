...
<head>
    ...
    <title>Forgot_password | Welcome to OCP</title>
    <!--global css starts-->
...
<div class="container">
    <div class="row">
        <div class="box animation flipInX">
            ...
            <form action="{{ route('members.password-confirm', compact(['userId','resetCode'])) }}" class="omb_loginForm pwd_validation"  autocomplete="off" method="POST">
                {!! Form::token() !!}
